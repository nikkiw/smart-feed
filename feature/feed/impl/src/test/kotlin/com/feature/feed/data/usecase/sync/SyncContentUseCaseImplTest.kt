...
class SyncContentUseCaseImplTest {
    ...
    @Test
    fun `successful sync rebuilds user and article recommendations`() =
        runTest {
    ...
    @Test
    fun `failed content sync does not rebuild recommendations`() =
        runTest {
    ...
    @Test
    fun `recommendation failure is returned from sync`() =
        runTest {
