...
import com.feature.feed.component.articlerecommendation.ArticleRecommendationsView
...
fun ViewContext.ArticleItemView(
    ...
    component.model.subscribe(lifecycle) { model ->
        when (val state = model.contentState) {
            ...
            ArticleItemComponent.ContentState.Loading -> {
                retry.visibility = View.GONE
            }

            is ArticleItemComponent.ContentState.Content -> {
                retry.visibility = View.GONE
...
private fun setupArticleScrollListener(
    ...
    scrollView.setOnScrollChangeListener {
        ...
        component.onReadProgressChanged(percentSeen)
