package com.feature.userprofile.data.repository
...
//        )
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_firstVisit_createsProfile() =
        runTest {
            // Arrange
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_secondVisit_updatesProfile() =
        runTest {
            // Arrange
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_firstVisit_calculatesCorrectEmbedding() =
        runTest {
            // Arrange
            val articleId = "article_1"
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_secondVisit_calculatesWeightedAverage() =
        runTest {
            // Arrange
            val articleId1 = "article_1"
            val articleId2 = "article_2"
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_multipleReadsOfSameArticle_usesUpdatedStats() =
        runTest {
            // Arrange
            val articleId = "article_1"
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_zeroEngagement_usesMinimalWeight() =
        runTest {
            // Arrange
            val articleId = "article_1"
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_maxEngagement_usesFullWeight() =
        runTest {
            // Arrange
            val articleId = "article_1"
            val articleEmbedding = floatArrayOf(1.0f, 2.0f, 3.0f)
            ...
            db.eventLogDao().insertEvent(
                EventLog(
                    ...
                    eventType = EventType.READ,
                    timestamp = System.currentTimeMillis(),
                    // 12 минут (больше максимума в 10 минут)
                    readingTimeMillis = 720000L,
                    readPercentage = 1.0f,
                ),
            )
            advanceUntilIdle()
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun onArticleVisited_articleWithoutEmbedding_returnsNull() =
        runTest {
            // Arrange
    ...
    private suspend fun setupArticle(
        articleId: String,
