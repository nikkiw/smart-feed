...
class UserProfileDaoTest {
    ...
    @Test
    fun testGetProfile_returnsNullWhenNotExists() =
        runTest {
    ...
    @Test
    fun testUpdateProfile_updatesExistingEntry() =
        runTest {
    ...
    @Test
    fun testVisitsCount_defaultValue() =
        runTest {
            val profile =
                UserProfileEntity(
                    userId = 1,
    ...
    @Test
    fun testMultipleProfiles_withDifferentIds() =
        runTest {
            val profile1 =
                UserProfileEntity(
                    userId = 1,
