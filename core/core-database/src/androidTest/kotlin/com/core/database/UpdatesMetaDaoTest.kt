...
class UpdatesMetaDaoTest {
    ...
    @Test
    fun test_save_other_id_does_not_affect_meta() =
        runTest {
    ...
    @Test
    fun test_save_empty_lastSyncAt() =
        runTest {
    ...
    @Test
    fun test_save_very_long_lastSyncAt() =
        runTest {
    ...
    @Test
    fun test_table_has_only_one_record_after_multiple_saves() =
        runTest {
