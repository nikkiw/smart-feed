...
class RecommendationDaoTest {
    ...
    @Test
    fun insertUserRecommendations_insertsCorrectly() =
        runTest {
            // Given
    ...
    @Test
    fun getUserRecommendations_returnsOrderedByScoreDesc() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3")
            insertTestContent(contentIds)
    ...
    @Test
    fun replaceUserRecommendations_replacesExistingData() =
        runTest {
            // Given
    ...
    @Test
    fun replaceUserRecommendations_withEmptyList_doesNothing() =
        runTest {
            // Given
    ...
    @Test
    fun deleteUserRecommendations_deletesAllData() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2")
            insertTestContent(contentIds)
    ...
    @Test
    fun insertContentRecommendations_insertsCorrectly() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3")
            insertTestContent(contentIds)
    ...
    @Test
    fun getContentRecommendations_returnsOrderedByScoreDesc() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3", "content4")
            insertTestContent(contentIds)
    ...
    @Test
    fun getContentRecommendations_filtersCorrectContentId() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3", "content4")
            insertTestContent(contentIds)
    ...
    @Test
    fun replaceContentRecommendations_replacesExistingForSameContent() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3", "content4")
            insertTestContent(contentIds)
    ...
    @Test
    fun replaceContentRecommendations_withEmptyList_doesNothing() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3")
            insertTestContent(contentIds)
    ...
    @Test
    fun deleteContentRecommendationsForContent_deletesOnlySpecificContent() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2", "content3", "content4")
            insertTestContent(contentIds)
    ...
    @Test
    fun onConflictReplace_updatesExistingRecords() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2")
            insertTestContent(contentIds)
    ...
    @Test
    fun flowUpdates_emitWhenDataChanges() =
        runTest {
    ...
    @Test
    fun foreignKeyConstraint_preventsOrphanedRecommendations() =
        runTest {
    ...
    @Test
    fun cascadeDelete_removesRecommendationsWhenContentDeleted() =
        runTest {
            // Given
            val contentIds = listOf("content1", "content2")
            insertTestContent(contentIds)

            val userRecommendations =
                listOf(
                    UserRecommendationEntity("content1", 0.9f),
                    UserRecommendationEntity("content2", 0.8f),
                )
