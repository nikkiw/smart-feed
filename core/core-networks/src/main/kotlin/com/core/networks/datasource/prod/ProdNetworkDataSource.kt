...
constructor(
    ...
    override suspend fun getUpdates(since: String, limit: Int): Result<UpdatesResponse> = withContext(ioDispatcher) {
        runSuspendCatching {
            api.getUpdates(since = since, limit = limit)
        }
    }

    override suspend fun getContentById(type: String, id: String): Result<ContentUpdate> = withContext(ioDispatcher) {
